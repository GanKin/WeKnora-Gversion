export default {
  ...
  knowledgeBase: {
    ...
    batchRebuild: 'Пересобрать выбранные',
    batchRebuildConfirmation: 'Подтверждение пакетной пересборки',
    confirmBatchRebuildDocument: 'Пересобрать {count} выбранных документов? Существующие фрагменты будут удалены и документы будут повторно проанализированы.',
    batchRebuildSuccess: 'Задача пересборки отправлена для {count} документов',
    batchRebuildPartial: 'Пересборка завершена: {success} успешно, {failed} с ошибками',
    batchRebuildFailed: 'Ошибка пакетной пересборки',
    batchMove: 'Переместить выбранные',
