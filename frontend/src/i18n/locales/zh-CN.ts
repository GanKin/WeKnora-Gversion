export default {
  ...
  knowledgeBase: {
    ...
    batchRebuild: "批量重建",
    batchRebuildConfirmation: "批量重建知识确认",
    confirmBatchRebuildDocument: "确认重建选中的 {count} 个文档？该操作会清理现有分块并重新解析。",
    batchRebuildSuccess: "已提交 {count} 个文档的重建任务",
    batchRebuildPartial: "重建完成：{success} 个成功，{failed} 个失败",
    batchRebuildFailed: "批量重建失败",
    batchMove: "批量移动",
    statusCompleted: "已完成",
