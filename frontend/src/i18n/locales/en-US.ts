export default {
  ...
  knowledgeBase: {
    ...
    batchRebuild: 'Rebuild selected',
    batchRebuildConfirmation: 'Confirm Batch Rebuild',
    confirmBatchRebuildDocument: 'Rebuild {count} selected documents? This will clear existing chunks and parse them again.',
    batchRebuildSuccess: 'Rebuild tasks submitted for {count} documents',
    batchRebuildPartial: 'Rebuild completed: {success} succeeded, {failed} failed',
    batchRebuildFailed: 'Batch rebuild failed',
