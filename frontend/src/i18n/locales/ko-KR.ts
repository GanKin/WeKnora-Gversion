export default {
  ...
  knowledgeBase: {
    ...
    batchRebuild: "선택 재구축",
    batchRebuildConfirmation: "일괄 재구축 확인",
    confirmBatchRebuildDocument: "선택한 {count}개 문서를 재구축하시겠습니까? 기존 청크가 삭제되고 다시 파싱됩니다.",
    batchRebuildSuccess: "{count}개 문서의 재구축 작업이 제출되었습니다",
    batchRebuildPartial: "재구축 완료: {success}개 성공, {failed}개 실패",
    batchRebuildFailed: "일괄 재구축 실패",
    batchMove: "선택 이동",
    statusCompleted: "완료",
